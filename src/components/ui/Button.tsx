    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-[#003087] text-white hover:bg-[#002060] focus:ring-[#003087]': variant === 'primary',
            ...
            'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-[#003087]': variant === 'outline',
          },
          {
